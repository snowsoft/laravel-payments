module.exports = {
    ...
    description: 'Laravel Payments is a flexible plans and subscription management system for Laravel.',
     ...
     */
    themeConfig: {
        repo: 'https://github.com/snowsoft/laravel-payments',
        editLinks: false,
        docsDir: '',
        editLinkText: '',
        lastUpdated: true,
