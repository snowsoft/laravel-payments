...
There are some things different to  [Laravel Payments Schedule](https://github.com/snowsoft/laravel-payments-schedule). In the
...
use Snow\Payments\Traits\IsScheduleService;
