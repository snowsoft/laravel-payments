...
namespace Snow\Payments\Tests;

use Snow\Payments\Models\Plan;
use Snow\Payments\Models\PlanFeature;
use Snow\Payments\PaymentsServiceProvider;
use Snow\Payments\Tests\Database\Factories\UserFactory;
...
class TestCase extends \Orchestra\Testbench\TestCase
{
    ...
    protected function getEnvironmentSetUp($app)
    {
        $app['config']->set('subby', [
            ...
            'services' => [
                'payment_methods' => [
                    'success' => \Snow\Payments\Tests\Services\PaymentMethods\SucceededPaymentMethod::class,
                    'fail' => \Snow\Payments\Tests\Services\PaymentMethods\FailedPaymentMethod::class
                ]
            ]
        ]);
