...
class PlanSubscriptionTest extends TestCase
{
    ...
    public function testAttachFeatureNotExistingInPlan()
    {
        ...
        $this->assertDatabaseHas(config('payments.tables.plan_subscription_features'), [
    ...
    {
        $this->expectException('Snow\Payments\Exceptions\InvalidPlanSubscription');
    ...
    {
        Config::set('payments.fallback_plan_tag', null);
    ...
    {
        Config::set('payments.fallback_plan_tag', 'pro');
        $this->testUser->subscription('main')->cancel();
    ...
    {
        Config::set('payments.fallback_plan_tag', 'super-pro');
