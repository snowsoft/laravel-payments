...
return new class extends Migration
{
    ...
    {
        Schema::create(config('payments.tables.plan_subscriptions'), function (Blueprint $table) {
            $table->increments('id');
            $table->string('tag');
            ...
            $table->foreign('plan_id')->references('id')->on(config('payments.tables.plans'))
    ...
    {
        Schema::dropIfExists(config('payments.tables.plan_subscriptions'));
    }
};
