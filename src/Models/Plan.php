...
use Snow\Payments\Traits\HasSubscriptionPeriod;
use Snow\Payments\Traits\HasTrialPeriod;
...
class Plan extends Model
{
    ...
    public function __construct(array $attributes = [])
    {
        ...
        $this->setTable(config('payments.tables.plans'));
    }
    ...
    {
        return [
            'tag' => 'required|max:150|unique:' . config('payments.tables.plans') . ',tag',
    ...
    {
        return $this->hasMany(config('payments.models.plan_combination'), 'plan_id', 'id');
    }
    ...
    {
        return $this->hasMany(config('payments.models.plan_feature'), 'plan_id', 'id');
    }
    ...
    {
        return $this->hasMany(config('payments.models.plan_subscription'), 'plan_id', 'id');
    }
