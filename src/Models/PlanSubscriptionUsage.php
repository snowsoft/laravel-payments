...
class PlanSubscriptionUsage extends Model
{
    ...
    public function __construct(array $attributes = [])
    {
        ...
        $this->setTable(config('payments.tables.plan_subscription_usage'));
    }
    ...
    {
        return [
            'plan_subscription_feature_id' => 'required|integer|exists:' . config('payments.tables.plan_features') . ',id',
    ...
    {
        return $this->belongsTo(config('payments.models.plan_subscription_feature'), 'plan_subscription_feature_id', 'id', 'feature');
    }
