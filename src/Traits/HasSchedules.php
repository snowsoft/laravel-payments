...
trait HasSchedules
{
    ...
    {
        return $this->hasMany(config('payments.models.plan_subscription_schedule'), 'subscription_id', 'id');
    }
     ...
     *
     * @return HasSchedules|\Snow\Payments\Models\PlanSubscription
     */
    ...
    public function getLatestSchedule(?Carbon $date = null)
    {
        ...
        return app(config('payments.models.plan_subscription_schedule'))
            ->pending($date)
